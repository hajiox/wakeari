            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div className="space-y-4">
                ...
                <div className="text-gray-700 leading-relaxed space-y-3">
                  <p>
                    豚本来の旨みを最も引き出す、<strong>カナダ産チルド豚バラ肉</strong>を使用。
                  </p>
                  <p>
                    当店では商品発売以来、一貫して冷凍の豚バラ肉を使用してきましたが、2026年4月よりカナダ産チルド豚バラ肉へ変更しました。
                  </p>
                  <p>
                    長年チャーシューを作り続けてきた私たちでも、今回の肉質の違いには正直驚きました。
                  </p>
                  <p>
                    しっとりとして柔らかく、豚肉特有の臭みが少ない。
                  </p>
                  <p>
                    脂の甘みと赤身の旨みが自然に広がり、豚肉本来のおいしさをしっかり楽しめる肉質です。
                  </p>
                  <p>
                    その肉質を活かすため、温度管理を徹底しながら一本ずつ丁寧に仕込みます。
                  </p>
                  <p>
                    職人が一本ずつ丁寧にタコ糸を巻き、<strong>手仕事ならではの「バラ巻き」製法</strong>で形を整え、じっくりと低温で煮込みます。このとき使用するのは、炭酸を加えた独自の下処理。臭みを抑え、筋繊維をやわらかくほどきながら、しっとりとした食感へと導きます。
                  </p>
                  <p>
                    さらに当店では、<strong>「育てる漬けダレ」</strong>にも深いこだわりがあります。仕込みを重ねるたびに継ぎ足され、肉汁と旨みが凝縮された秘伝のタレは、時間とともにゼラチン状の旨みの塊に。
                  </p>
                  <p>
